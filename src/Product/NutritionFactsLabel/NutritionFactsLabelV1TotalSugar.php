...
class NutritionFactsLabelV1TotalSugar
{
    ...
    /**
     * @var float DVs are the recommended amounts of total sugars to consume or not to exceed each day.
     */
    public ?float $dailyValue;
    /**
     * @var float The amount of total sugars per 100g of the product.
     */
    public ?float $per100G;
    /**
     * @var float The amount of total sugars per serving of the product.
     */

...
class NutritionFactsLabelV1TransFat
{
    ...
    /**
     * @var float DVs are the recommended amounts of trans fat to consume or not to exceed each day.
     */
    public ?float $dailyValue;
    /**
     * @var float The amount of trans fat per 100g of the product.
     */
    public ?float $per100G;
    /**
     * @var float The amount of trans fat per serving of the product.
     */

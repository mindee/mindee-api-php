...
class NutritionFactsLabelV1Protein
{
    ...
    /**
     * @var float DVs are the recommended amounts of protein to consume or not to exceed each day.
     */
    public ?float $dailyValue;
    /**
     * @var float The amount of protein per 100g of the product.
     */
    public ?float $per100G;
    /**
     * @var float The amount of protein per serving of the product.
     */

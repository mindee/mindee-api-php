...
class NutritionFactsLabelV1TotalFat
{
    ...
    /**
     * @var float DVs are the recommended amounts of total fat to consume or not to exceed each day.
     */
    public ?float $dailyValue;
    /**
     * @var float The amount of total fat per 100g of the product.
     */
    public ?float $per100G;
    /**
     * @var float The amount of total fat per serving of the product.
     */

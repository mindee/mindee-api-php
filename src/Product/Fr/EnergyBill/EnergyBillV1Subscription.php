...
class EnergyBillV1Subscription
{
    ...
    /**
     * @var string Description or details of the subscription.
     */
    public ?string $description;
    /**
     * @var string The end date of the subscription.
     */
    ...
    /**
     * @var float The total cost of subscription.
     */
    public ?float $total;
    /**
     * @var float The price per unit of subscription.
     */

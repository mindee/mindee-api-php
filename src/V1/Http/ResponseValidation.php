...
class ResponseValidation
{
     ...
     *
     * @param array<string, integer|float|string|bool|null|array<mixed>> $response A response object.
     * @return boolean
     */
     ...
     *
     * @param array<string, integer|float|string|bool|null|array<mixed>> $response A response array.
     * @return boolean
     */
     ...
     *
     * @param array<string, integer|float|string|bool|null|array<mixed>> $response An endpoint response array.
     * @return array<string, integer|float|string|bool|null|array<mixed>> A cleaned response array.
     */

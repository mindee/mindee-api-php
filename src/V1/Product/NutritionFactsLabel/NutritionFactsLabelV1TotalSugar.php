 ...
 */
class NutritionFactsLabelV1TotalSugar implements Stringable
{
    use FieldConfidenceMixin;
    use FieldPositionMixin;

    /**
     * @var float|null DVs are the recommended amounts of total sugars to consume or not to exceed each day.
     */
    public ?float $dailyValue;
    /**
     * @var float|null The amount of total sugars per 100g of the product.
     */
    public ?float $per100G;
    /**
     * @var float|null The amount of total sugars per serving of the product.
     */

 ...
 */
class NutritionFactsLabelV1DietaryFiber implements Stringable
{
    use FieldConfidenceMixin;
    use FieldPositionMixin;

    /**
     * @var float|null DVs are the recommended amounts of dietary fiber to consume or not to exceed each day.
     */
    public ?float $dailyValue;
    /**
     * @var float|null The amount of dietary fiber per 100g of the product.
     */
    public ?float $per100G;
    /**
     * @var float|null The amount of dietary fiber per serving of the product.
     */

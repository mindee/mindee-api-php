 ...
 */
class NutritionFactsLabelV1TotalFat implements Stringable
{
    use FieldConfidenceMixin;
    use FieldPositionMixin;

    /**
     * @var float|null DVs are the recommended amounts of total fat to consume or not to exceed each day.
     */
    public ?float $dailyValue;
    /**
     * @var float|null The amount of total fat per 100g of the product.
     */
    public ?float $per100G;
    /**
     * @var float|null The amount of total fat per serving of the product.
     */

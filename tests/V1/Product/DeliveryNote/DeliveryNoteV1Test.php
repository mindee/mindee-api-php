...
class DeliveryNoteV1Test extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->completeDoc = new Document(\Mindee\V1\Product\DeliveryNote\DeliveryNoteV1::class, $completeDocJSON["document"]);
        $this->emptyDoc = new Document(\Mindee\V1\Product\DeliveryNote\DeliveryNoteV1::class, $emptyDocJSON["document"]);

...
class MultiReceiptsDetectorV1TestRegression extends TestCase
{
    ...
    protected function setUp(): void
    {
        $productDir = (getenv('GITHUB_WORKSPACE') ?: ".") .
            "/tests/resources/products/multi_receipts_detector/response_v1/";
    ...
    public function testRegression()
    {
        $inputSource = $this->mindeeClient->sourceFromPath(
            (getenv('GITHUB_WORKSPACE') ?: ".") . "/tests/resources/products/multi_receipts_detector/default_sample.jpg"
        );
        $response = $this->mindeeClient->parse(MultiReceiptsDetectorV1::class, $inputSource);

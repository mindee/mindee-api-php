...
class BankCheckV1TestRegression extends TestCase
{
    ...
    protected function setUp(): void
    {
        $productDir = (getenv('GITHUB_WORKSPACE') ?: ".") .
            "/tests/resources/products/bank_check/response_v1/";
    ...
    public function testRegression()
    {
        $inputSource = $this->mindeeClient->sourceFromPath(
            (getenv('GITHUB_WORKSPACE') ?: ".") . "/tests/resources/products/bank_check/default_sample.jpg"
        );
        $response = $this->mindeeClient->parse(BankCheckV1::class, $inputSource);

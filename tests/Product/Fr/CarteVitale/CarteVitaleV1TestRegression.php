...
class CarteVitaleV1TestRegression extends TestCase
{
    ...
    protected function setUp(): void
    {
        $productDir = (getenv('GITHUB_WORKSPACE') ?: ".") .
            "/tests/resources/products/carte_vitale/response_v1/";
    ...
    public function testRegression()
    {
        $inputSource = $this->mindeeClient->sourceFromPath(
            (getenv('GITHUB_WORKSPACE') ?: ".") . "/tests/resources/products/carte_vitale/default_sample.jpg"
        );
        $response = $this->mindeeClient->parse(CarteVitaleV1::class, $inputSource);

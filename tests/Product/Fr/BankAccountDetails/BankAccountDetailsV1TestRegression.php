...
class BankAccountDetailsV1TestRegression extends TestCase
{
    ...
    protected function setUp(): void
    {
        $productDir = (getenv('GITHUB_WORKSPACE') ?: ".") .
            "/tests/resources/products/bank_account_details/response_v1/";
    ...
    public function testRegression()
    {
        ...
        $response = $this->mindeeClient->parse(BankAccountDetailsV1::class, $inputSource);

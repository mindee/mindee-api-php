...
class IdCardV1TestRegression extends TestCase
{
    ...
    protected function setUp(): void
    {
        $productDir = (getenv('GITHUB_WORKSPACE') ?: ".") .
            "/tests/resources/products/idcard_fr/response_v1/";
    ...
    public function testRegression()
    {
        ...
        $response = $this->mindeeClient->parse(IdCardV1::class, $inputSource);

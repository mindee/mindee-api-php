...
class PassportV1TestRegression extends TestCase
{
    ...
    protected function setUp(): void
    {
        $productDir = (getenv('GITHUB_WORKSPACE') ?: ".") .
            "/tests/resources/products/passport/response_v1/";
    ...
    public function testRegression()
    {
        $inputSource = $this->mindeeClient->sourceFromPath(
            (getenv('GITHUB_WORKSPACE') ?: ".") . "/tests/resources/products/passport/default_sample.jpg"
        );
        $response = $this->mindeeClient->parse(PassportV1::class, $inputSource);

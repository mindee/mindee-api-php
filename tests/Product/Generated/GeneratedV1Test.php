...
const PRODUCT_DATA_DIR = "./tests/resources/products/";
...
class GeneratedV1Test extends TestCase
{
    ...
    protected function setUp(): void
    {
        $this->internationalIdV1CompleteDoc = new Document(
            GeneratedV1::class,
            json_decode(
                file_get_contents(PRODUCT_DATA_DIR . "/generated/response_v1/complete_international_id_v1.json"),
                true
            )["document"]
        );
        ...
        $this->internationalIdV1EmptyDoc = new Document(
            GeneratedV1::class,
            json_decode(
                file_get_contents(PRODUCT_DATA_DIR . "/generated/response_v1/empty_international_id_v1.json"),
                true
            )["document"]
        );
        ...
        $this->invoiceV4EmptyDoc = new Document(
            GeneratedV1::class,
            json_decode(
                file_get_contents(PRODUCT_DATA_DIR . "/generated/response_v1/empty_invoice_v4.json"),
                true
            )["document"]
        );
        ...
        $this->invoiceV4CompleteDoc = new Document(
            GeneratedV1::class,
            json_decode(
                file_get_contents(PRODUCT_DATA_DIR . "/generated/response_v1/complete_invoice_v4.json"),
                true
            )["document"]
        );
    ...
    {
        $docStr = file_get_contents(PRODUCT_DATA_DIR . "/generated/response_v1/summary_empty_international_id_v1.rst");
    ...
    {
        $docStr = file_get_contents(PRODUCT_DATA_DIR . "/generated/response_v1/summary_full_international_id_v1.rst");
    ...
    {
        $docStr = file_get_contents(PRODUCT_DATA_DIR . "/generated/response_v1/summary_full_invoice_v4.rst");
